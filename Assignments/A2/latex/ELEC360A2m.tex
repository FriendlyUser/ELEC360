...
The value $0 < K < 10.5$, so the critical value of K, $K_{cr} =10.5$ \hfill \break
...
\begin{figure}
	\centering
	\includegraphics [width=0.7\linewidth]{rlocusQ67Anno.png}
...
\begin{figure}[h]
	\centering
	\includegraphics [width=0.6\linewidth]{rlocusQ614Anno.png}
...
\begin{figure}
	\centering
	\includegraphics [width=0.7\linewidth]{ELEC360A2m_03.png}
...
\begin{figure}[h]
	\centering
	\includegraphics [width=0.7\linewidth]{polesZeroes.pdf}
...
\begin{figure}
	\centering
	\includegraphics [width=0.7\linewidth]{ELEC360A2m_04.png}
...
& G(s) =10 \frac{1}{9}\cfrac{s^2+0.4s+1}{s(\frac{s^2}{9}+\frac{0.8s}{9}+1)}
\end{align}
