...
\begin{figure}[H]
	\centering
	\includegraphics [width=0.75\linewidth]{stepQ2614.png}
...
\begin{figure}[H]
	\centering
	\includegraphics [width=0.75\linewidth]{stepQ42.png}
...
\begin{figure}[h]
	...
	\caption{Block Diagram from B-6-20}
	% Alternative is to typeset the caption myself, which makes more sense to me.
...
& |G(j\omega)| = 20 log_{10} \sqrt{(1-\omega)^2+(0.4\omega)^2}- 20log_{10}\sqrt{(-\omega^3+9)^2+(-0.8\omega)^2} \\
& \phase{G(j\omega)} = \tan^{-1}\left(\frac{0.4 \omega}{1-\omega^2}\right)-\tan^{-1}\left(\frac{\omega^3+9}{0.8\omega^2}\right) 
\end{align*}
...
\begin{figure}[h]
	\centering
	\includegraphics [width=0.7\linewidth]{stepQ6Bode.png}
...
%	\toprule
%	\textbf\{Week of Oct 8\} &                                          \textbf\{Week of Oct 15\} &                                        \textbf\{Week of Oct 22\} &                         \textbf\{Week of Nov 5\} &                        \textbf\{Week of Nov 12\} \\
%	\midrule
%	2 hours reading pages 13 to 22 of text  &  3 hours spent on deriving transfer functions of example systems &  3 hours spent on preparing for lab &  2 hours doing the prelab and reading textbook &  2 hours doing the prelab and reading textbook \\
%	3 hours of internet research on closed loop control system examples &  2 hours towards practicing block-diagram reduction techniques &  2 hours towards practicing block-diagram reduction techniques &  2 hours reviewing and creating lecture notes &  2 hours reviewing and creating lecture notes \\
%	1 hour of practicing Laplace Transform &  2 hours on solving first 4 questions of assignment 1 &  2 hours on solving first 4 questions of assignment 1 &  6 hours solving questions of assignment 1 &  6 hours solving questions of assignment 1 \\
%	\bottomrule
%\end{tabular}
%
%\begin{table}
%	\begin{tabular}{cccc}                                                      Week of Oct 8 &  2 hours reading pages 13 to 22 of text        & 3 hours of internet research on closed loop control system examples & 1 hour of practicing Laplace Transform               \\
%		Week of Oct 15                                                                        & 3 hours spent on deriving transfer functions of example systems & 2 hours towards practicing block-diagram reduction techniques       & 2 hours on solving first 4 questions of assignment 1 \\
%		Week of Oct 22                                                                        & 3 hours spent on preparing for lab                              & 2 hours towards practicing block-diagram reduction techniques       & 2 hours on solving first 4 questions of assignment 1 \\
%		Week of Nov 5                                                                         & 2 hours doing the prelab and reading textbook                   & 2 hours reviewing and creating lecture notes                        & 6 hours solving questions of assignment 1            \\
%		Week of Nov 12                                                                        & 2 hours doing the prelab and reading textbook                   & 2 hours reviewing and creating lecture notes                        & 6 hours solving questions of assignment 1            \\
%	\end{tabular}
%\end{table}
...
%	\begin{tabular}{LLLLL}
%		\toprule                                                       Week of Oct 8 & Week of Oct 15                                                  & Week of Oct 22                                                & Week of Nov 5                                 & Week of Nov 12                                \\
%		\midrule 2 hours reading pages 13 to 22 of text                              & 3 hours spent on deriving transfer functions of example systems & 3 hours spent on preparing for lab                            & 2 hours doing the prelab and reading textbook & 2 hours doing the prelab and reading textbook \\
%		3 hours of internet research on closed loop control system examples                   & 2 hours towards practicing block-diagram reduction techniques   & 2 hours towards practicing block-diagram reduction techniques & 2 hours reviewing and creating lecture notes  & 2 hours reviewing and creating lecture notes  \\
%		1 hour of practicing Laplace Transform                                                & 2 hours on solving first 4 questions of assignment 1            & 2 hours on solving first 4 questions of assignment 1          & 6 hours solving questions of assignment 1     & 6 hours solving questions of assignment 1     \\
%	\end{tabular}
%\end{table}
