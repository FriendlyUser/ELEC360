...
sys = tf([1,zc],D.coeffs.tolist())
#sys = tf([1,zc],[1,7,14,8])
...
D2 = sterm*D
K = 20
sys = tf((K*N).coeffs.tolist(),(K*N+D).coeffs.tolist())
N = poly1d([1,0.2])
sys1 = tf((K*N).coeffs.tolist(),(K*N+D2).coeffs.tolist())
N = poly1d([1,0.1])
sys2 = tf((K*N).coeffs.tolist(),(K*N+D2).coeffs.tolist())
...
K = 20
N = poly1d([1])
sys = tf(D.coeffs.tolist(),(sterm*(K*N+D)).coeffs.tolist())
N = poly1d([1,0.2])
